/*
 * WeAct 2.13 E-Paper Display Test for NRF54L14-DK
...
{
	LOG_INF("========================================");
	LOG_INF("WeAct 2.13\" E-Paper Display Test");
	LOG_INF("========================================");
	LOG_INF("Board: NRF54L14-DK");
...
void test_display_text(void)
{
	...
	epd_paint_show_string(epaper_dev, 10, 25, "2.13\" E-Paper",
	                      EPD_FONT_SIZE8x6, EPD_COLOR_BLACK);
	...
	epd_paint_show_string(epaper_dev, 10, 65, "Board: NRF54L14",
	                      EPD_FONT_SIZE8x6, EPD_COLOR_BLACK);
...
int main(void)
{
	...
	LOG_INF("Initializing 2.13\" E-Paper display...");
